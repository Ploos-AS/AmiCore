...
module amcore_68k_baseline(
 ...
 always_comb begin
  ...
  case(state)
   S_RESET_SSP_HI:begin address=0;read=1;end S_RESET_SSP_LO:begin address=2;read=1;end S_RESET_PC_HI:begin address=4;read=1;end S_RESET_PC_LO:begin address=6;read=1;end S_FETCH:if(!irq_pending)begin address=pc;read=1;end S_IMM_SR,S_BRANCH_EXT,S_DBCC_EXT,S_JUMP_EXT_W,S_JUMP_EXT_HI,S_EA_EXT_W,S_EA_EXT_HI,S_MOVE_EXT,S_MOVE_ABS_HI:begin address=pc+2;read=1;end S_JUMP_EXT_LO,S_EA_EXT_LO,S_MOVE_ABS_LO:begin address=pc+4;read=1;end
