// AmiCore M1.12 — minimal clean-room 68000 execution baseline.
// M1.12 adds user/supervisor stack-pointer banking and MOVE USP support.
module amcore_68k_baseline(
 ...
 state_t state; logic[31:0]dreg[0:7],areg[0:7],usp,ssp; logic[15:0]ir,reset_hi,vector_hi,rte_pc_hi,rts_pc_hi,rte_sr; logic[31:0]exception_pc;logic[15:0]exception_sr;logic[3:0]quick_value;logic irq_pending;logic[31:0]alu_result;logic[32:0]alu_wide;logic alu_x,alu_n,alu_z,alu_v,alu_c;logic[31:0]mem_ea,mem_value;logic[2:0]mem_dreg,mem_areg;logic[1:0]mem_update;logic branch_is_bsr;logic[31:0]branch_return;integer i;
